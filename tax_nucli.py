# -*- coding: utf-8 -*-
"""tax/tax_nucli.py — el catàleg d'errors que ja existia.

MÒDUL CONGELAT. No s'hi afegeixen etiquetes noves: cada via de treball té el
seu propi `tax_<tema>.py`. Vegeu `tax/__init__.py`.
